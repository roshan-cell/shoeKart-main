          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              ...
              <div className="flex border-t border-gray-200 py-2">
                <span className="text-gray-500">Sneaky-Peaky shoes </span>
              ...
              <div className="flex border-t border-b mb-6 border-gray-200 py-2">
                <span className="text-gray-500">Sneaky-Peaky shoes</span>
                <span className="ml-auto text-gray-900">xxl</span>
                <span className="ml-auto text-gray-900">499</span>
              </div>
              <div className="flex">
                ...
                <button className="flex ml-auto text-white bg-red-800 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
                  Track Order
                </button>
